dict={
    1:"""Pradhan Mantri Kisan Samman Nidhi (PM-KISAN) is a new Central Sector Scheme to provide income support to all landholding farmers' families in the country to supplement their financial needs for procuring various inputs related to agriculture and allied activities as well as domestic needs.
Eligibility-
...
Common FAQs-
1.What is the cutoff date for determination of eligibility of beneficiaries under the scheme?
...
2. Whether the scheme benefits will be allowed in cases where transfer of ownership of cultivable land takes place after the cut-off date of 01.02.2019 on account of succession due to death of the landowner?
...
3.What is the definition of 'family' under the Scheme?
...
4.What is the prescribed mechanism for validation of information / declaration furnished by the beneficiaries?
...
5.Whether micro land holdings are admissible for availing the benefit of the Scheme?
Micro land holdings, which are not cultivable, are excluded from the benefit under the scheme.

""",
2:""" Government has launched the Pradhan Mantri Kisan Maan Dhan Yojana (PM-KMY) on 12.9.2019 with a view to provide social security to Small and Marginal Farmers in their old age when they have no means of livelihood and minimal or no savings to take care of their expenses.
...
Monthly Contributions: Monthly contributions are in the range from Rs. 55 to Rs. 200, based on the farmer's age at the time of entry into the Scheme, according to the contribution chart.Leaving the Pension Scheme
If an eligible subscriber exits the Scheme within less than ten years of joining, then the share of contribution will be returned along with the savings bank rate of interest payable thereon.
If the subscriber exits after ten years but before reaching age sixty, they will receive their contributions plus accumulated interest, either as earned by the Pension Fund or at the savings bank rate, whichever is higher.
Suppose a subscriber dies while making regular contributions. In that case, their spouse can either continue the Scheme with regular contributions or exit by receiving the subscriber's contributions plus accumulated interest, as earned by the Pension Fund or at the savings bank rate, whichever is higher.
Upon the subscriber's and spouse's death, the remaining corpus shall be returned to the fund.
Eligibility
Small and Marginal Farmer (SMF) - a farmer who owns cultivable land upto 2 hectare as per land records of the concerned State/UT as of 1st August 2019.
Age of 18- 40 years
...
How to apply
To enroll in the scheme, eligible farmers need to visit the nearest Common Service Center (CSC) or contact the Nodal Officer (PM-Kisan) appointed by the State or UT Governments. The enrollment is free of cost.
...
Farmers / Spouses name and date of birth
Bank account number
IFSC/ MICR Code
Mobile Number
Aadhaar Number
 """,
 3:"""Pradhan Mantri Fasal Bima Yojana:Insurance protection for food crops, oilseeds and annual horticultural/commercial crops notified by state government.
Uniform maximum premium for all farmers:
Kharif season - 2 percent of sum insured.
Rabi Season 1.5 percent of sum insured.
Annual commercial/horticultural crops - 5 percent of sum insured
...
If the sowing is not done due to adverse weather/climate, claims upto 25 percent of sum insured will be paid for prevented sowing/planting risk.
...
If 50 loss in mid season of crop then on account advance payment, upto 25 percent of likely claims will be paid as immediate relief.
...
def get_scheme_data(schemeName):
    if schemeName == "Pradhan Mantri Kisan Samman Nidhi":
        return dict[1]
    elif schemeName == "Pradhan Mantri Kisan Maan Dhan Yojana":
        return dict[2]
    elif schemeName == "Pradhan Mantri Fasal Bima Yojana":
        return dict[3]

    data =get_scheme_data("Pradhan Mantri Kisan Samman Nidhi")
